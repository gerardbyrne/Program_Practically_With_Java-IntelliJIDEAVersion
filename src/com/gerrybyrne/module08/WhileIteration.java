...
public class WhileIteration 
{
	public static void main(String[] args) 
	{
        ...
        */
		...
		/*
		Set up variable called numberOfClaimsBeingMade, maximumNumberOfClaims,numberOfClaimsEntered of data type int
		*/
        int numberOfClaimsBeingMade; 
        int maximumNumberOfClaims = 5; // was int maximumNumberOfClaims = 0;
        ...
        */
        ...
        /*
        Here we use the while iteration which uses a Boolean test to see if
        the number of claims entered by the user so far is less than the
        number of claims being made. If the comparison equates to true then
        the while loop block of code is executed. If the comparison equates
      ...
      */
      while (numberOfClaimsEntered < numberOfClaimsBeingMade)
      {
    	  ...
    	  /* 
          We will use the if statement to perform a boolean test and if the
          test produces a true value we will break out of the loop.
          If the boolean test produces a false value the loop simply continues 
        ...
        */
        ...
        produces a true value we will continue with the loop but will skip out
        of this current iteration. In this example we will check if the value
        of the counter is even (when we divide by 2 the remainder is 0). If
        it is an even number we will skip the rest of this iteration by using 
        the continue statement. There is no else part to the if statement so
        if the boolean test produces a false value the loop carries on    
        executing the block of code 
      */
