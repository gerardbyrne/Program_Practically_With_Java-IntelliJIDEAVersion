...
package com.gerrybyrne.module05;
...
public static void main(String[] args) 
{
	...
	*/
    ...
    short maximumAmountForCarHire = 0;
 	...
 	String fullyComprehensiveUserInput = "True";
 	boolean fullyComprehensiveRequirement = true;
...
System.out.println("Do we require fully comprehensive insurance (enter the word true or false)?\n");

fullyComprehensiveRequirement = Boolean.parseBoolean(myScanner.next());

System.out.println("It is " + fullyComprehensiveRequirement + " that we require fully comprehensive insurance");

/* 
 Now we are trying to put the int variable maximumAmountForRepairCosts into
the short variable maximumAmountForCarHire. This is not possible without
something being changed. This is where the error message will appear and a cast
comes into play 
*/
maximumAmountForCarHire = (short) maximumAmountForRepairCosts;

//System.out.println("The int variable maximumAmountForRepairCosts has a value of " + maximumAmountForRepairCosts);

//System.out.println("\nThe short variable maximumAmountForCarHire has a value of " + maximumAmountForCarHire);

System.out.println("What is the age, in full years, of the vehicle? \n");

vehicleAgeInYears = Integer.parseInt(myScanner.next());
