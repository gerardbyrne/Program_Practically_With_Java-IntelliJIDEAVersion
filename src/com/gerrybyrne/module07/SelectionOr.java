...
public class SelectionOr 
{
	public static void main(String[] args) 
	{
	    ...
	    int ageOfDriver = 0;
		  ...
		  /*
	      Now we will check if the years of no claims is greater than 10 AND
	      if the age of the driver is greater than 40. If both are TRUE we 
	      have the Boolean expression TRUE AND TRUE which equates to TRUE 
	      ...
	      else code block and execute some lines of code in this code block
	      */
		  if (yearsOfNoClaims > 10 && ageOfDriver > 40)
	      {
	          /*
	            This block of code will be executed if the both
